...
namespace FileReader___Katharine_Wunderle
{
    ...
    //ID: 623748
    //Date: 05/09/2021
    //Goal: Browse for, then read and display the contents of a text file.
    public partial class Form1 : Form
    {
        ...
        {
            //Open file dialog box with browse button
            if (openFileDialog1.ShowDialog() == DialogResult.OK)
            //Open selected file
            { filePathInpt.Text = openFileDialog1.FileName; }
            //Otherwise do nothing
            else { filePathInpt.Text = ""; }
        }
    }
}
